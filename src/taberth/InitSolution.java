...
public class InitSolution {
    ...
    public InitSolution(ArrayList<Ship> listship,ArrayList<Berth> listberth,ArrayList<BerthTrans> listbertha){
        
        this.listberth=listberth;
        this.listship=listship;
        this.listbertha=listbertha;

        ArrayList<Ship> initialsolution = new ArrayList<Ship>();
...
//            System.out.println(i+". Mnow = " + M);
        ...
        this.initialsol2=(ArrayList)listship.clone();
        return listship;
    }
